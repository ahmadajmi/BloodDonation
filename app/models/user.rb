...
class User < ActiveRecord::Base
  ...
  validates_length_of :phone, minimum: 11, maximum: 11, message: I18n.t('phone_length')
  ...
  validates_length_of :nationalid, minimum: 14, maximum: 14, message: I18n.t('national_id_length')
